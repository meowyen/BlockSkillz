   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "b'-----BEGIN PUBLIC KEY-----\\nMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDZxTA3ftZpKrd5MDzt7lVtC7ET\\n2/Av2mUjGdKSllYs2ygpbEtGhmQLtWDg17GsImbf3x+kszS9IJGfmGPjTAR/0WXS\\nLHB9MHJhKgh+1Zc78dR//LMNqHskZw1sCnNqJRH0gsygAasuWvxSYa4PnVtzfeGi\\nZwh0ByYwyvUGpKvsSwIDAQAB\\n-----END PUBLIC KEY-----'\n"
     ]
    }
   ],
   "source": [
